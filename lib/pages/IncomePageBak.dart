...
class _IncomePageState extends State<IncomePage> {
  ...
  void initState() {
    ...
    loadData().then((value) {
      ...
      int payFrequency = value.getPayFrequency();
      _incomeList.forEach((incValue) {
        print("HERE");
        if (incValue.payFrequency == payFrequency) {
          _currentSelectedValue = incValue;
        }
      });
    });
    super.initState();
                                  ...
                                  child: DropdownButton<PayFrequency>(
                                    ...
                                    onChanged: (PayFrequency newValue) {
                                      setState(() {
                                        ...
                                        income.setPayFrequency(_currentSelectedValue.payFrequency);
                                        income.saveIncome(income);
                                      });
                                    },
                                    items:
                                    _incomeList.map((PayFrequency value) {
